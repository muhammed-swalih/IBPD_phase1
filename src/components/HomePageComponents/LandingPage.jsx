    ...
    <div className=" md:w-full h-screen bg-black">
      ...
      >
        ...
        <div className=" h-screen flex items-center   w-full ">
          <div className=" w-full  md:flex md:justify-start  md:w-auto md:px-10   bg-black bg-opacity-50">
            <div className=" flex flex-col gap-2 text-white">
              <img
                ...
                alt=""
              />
              <div className=" gap-2 px-10 md:px-0 pb-10 flex flex-col md:gap-5 py-5 md:py-10">
