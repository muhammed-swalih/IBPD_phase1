    ...
    <div className=" w-full h-auto pb-20 flex flex-col gap-12">
      ...
      <div className=" px-20 flex flex-col gap-8">
        <div className=" flex flex-col gap-1">
          ...
          <h1 className=" text-justify w-[830px]">
      ...
      <div className=" mx-20">
        <div className=" w-[1000px] py-8 px-10 bg-black rounded-xl">
          <div className=" flex flex-col gap-3">
            <h1 className=" text-3xl text-white font-semibold">
              Join IBPD and Redefine Your Professional Journey.
            </h1>
            <hr className=" w-[830px] border-gray-600" />
            <h1 className=" w-[830px] text-white">
